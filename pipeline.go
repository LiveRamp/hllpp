...
const (
	...
	// Whether to always write 'dense' PipelineDB HLLs. This may be desirable
	// to enable if maximum precision is desired. There are some observed
	// precision issues when taking the cardinality or unions of explicit
